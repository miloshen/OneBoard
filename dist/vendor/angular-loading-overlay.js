    ...
    function bsLoadingOverlay($compile, $rootScope, $templateRequest, $q, $timeout, bsLoadingOverlayService) {
        function link(scope, $element, $attributes) {
            ...
            function updateOverlayElement(referenceId) {
                if (!bsLoadingOverlayService) return;
                if (overlayElement) bsLoadingOverlayService.isActive(referenceId) ? overlayElement.isAttached || addOverlay() : overlayElement.isAttached && removeOverlay();
            }
            function addOverlay() {
